...
import com.example.coroutinesconcepts.databinding.FragmentFirstBinding
...
class FirstFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val myCustomTextView = MyCustomTextView(requireContext(),"Purple",android.R.color.darker_gray)
